...
namespace DDD.Application.Api.Controllers
{
    ...
    {
        readonly IColetaApplication _denunciasRepository;

        public DenunciasController(IColetaApplication denunciasRepository)
        {
        ...
        [HttpPost]
        public IActionResult InsertDenuncias(Coleta denuncias)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult UpdateDenuncias(Coleta denuncias)
        {
            try
            {
